...
export default function Phase3Page() {
    ...
    const src = lang === 'ko' ? '/phase3-llm-api-prompt-guide-ko.html' : '/phase3-llm-api-prompt-guide.html'
        ...
        <div className="max-w-5xl mx-auto px-4 md:px-6 py-8 md:py-16">
            ...
            <div className="rounded-xl overflow-hidden border border-gray-700 bg-gray-900">
                <iframe ref={iframeRef} key={lang} src={src} className="w-full border-0"
                    style={{ height: `${iframeHeight}px` }} scrolling="no" onLoad={handleLoad} title="Phase 3" />
            </div>
        </div>
    )
}
